...
public class BMBatarangEntity extends ModdedProjectileEntity {
    @Nullable
    private IStandPower userStandPower;
    private boolean lowerKnockback;
    private boolean breakBlocks;

    public BMBatarangEntity(LivingEntity shooter, World world, @Nullable IStandPower standPower) {
        super(InitEntities.BM_BATARANG.get(), shooter, world);
        userStandPower = standPower;
    }

    public BMBatarangEntity(EntityType<? extends BMBatarangEntity> type, World world) {
        super(type, world);
    }
