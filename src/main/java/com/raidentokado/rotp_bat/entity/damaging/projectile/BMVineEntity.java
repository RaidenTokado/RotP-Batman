package com.raidentokado.rotp_bat.entity.damaging.projectile;
...
public class BMVineEntity extends OwnerBoundProjectileEntity {
    ...
    public BMVineEntity(World world, LivingEntity entity, float angleXZ, float angleYZ, boolean isBinding) {
        super(InitEntities.BM_VINE.get(), entity, world);
        this.yRotOffset = angleXZ;
        this.xRotOffset = angleYZ;
        this.isBinding = isBinding;
    }

    public BMVineEntity(EntityType<? extends BMVineEntity> entityType, World world) {
    ...
    protected void afterEntityHit(EntityRayTraceResult entityRayTraceResult, boolean entityHurt) {
        if (entityHurt) {
            ...
            playSound(InitSounds.BATMAN_GRAPPLE_CATCH.get(), .25F, 1.0F);
    ...
    public BMVineEntity setHamonDamageOnHit(float damage, float hitCost, boolean useBreathStab){
    ...
    public BMVineEntity setBaseUsageStatPoints (float points){
